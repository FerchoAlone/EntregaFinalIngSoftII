...
public class User {
     ...
     *
     * @param stock
     * @return RESPONSE_SUCCESS if the stock is added, ALREADY_EXISTS if the
     ...
     *
     * @param stockId
     * @return RESPONSE_SUCCESS in case of success, NOT_FOUND if the stock was
     * not in myStocks
     */
     ...
     * @param stockId
     * @param newValue
     * @return StatusCode given by updateLowerLimit function, NOT_FOUND if the
     * stock did not exist in myStocks
     */
     ...
     * @param stockId
     * @param newValue
     * @return StatusCode given by updateUpperLimit function, NOT_FOUND if the
     * stock did not exist in myStocks
     */
